            ...
            <body style="background-color: #eeeeee;">
                ...
                <div class="card-pembayaran p-3 me-5 shadow d-flex justify-content-center flex-column rounded-3 overflow-hidden"
                    ...
                    <div class="main-content px-5">
                        <form action="{{ route('pembayaran.store') }}" method="post" class="my-3"
                            ...
                            <div class="my-4 form-input">
                                <input type="text" class="form-control px-5 shadow py-3 border"
                                    placeholder="Isi Nominal Donasi (minimal 10.000)" name="nominal" required
                            ...
                            <div class="mb-4 form-input">
                                <select class="form-select px-5 shadow py-3" name="nama_bank"
                                    aria-label="Default select example" id="payment-method" required>
                            ...
                            <div class="form-input mb-3 data mt-4">
                                ...
                                <input type="text" class="form-control shadow py-3 border nama-donatur"
                                    placeholder="Masukan Nama Donatur" name="pemilik_bank" required>
                            </div>
                            <div class="no-hp my-3">
                                <input type="number" class="form-control shadow py-3 border"
                                    placeholder="Masukan Nomer telpon Anda" name="no_telpon" required>
                            </div>

                            <div class="mb-3">
                                <label for="formFileLg" class="form-label">Input Bukti Pembayaran</label>
                                <input class="form-control form-control-lg border" id="formFileLg" name="image"
                                    type="file">
                            </div>
